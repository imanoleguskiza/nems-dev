...
$title = call_user_func('t', $item['link']['title']);
$caption = call_user_func('t', $item_config['caption']);

?>
<li <?php print $attributes;?> class="<?php print $classes;?>">
  <?php if(in_array($item['link']['href'], array('nolink'))): ?>
    <span class="nolink-submenu-title">
      ...
      <?php if(!empty($item_config['caption'])) : ?>
        <span class="mega-caption"><?php print $caption; ?></span>
      <?php endif;?>
    </span>
  <?php else : ?>
